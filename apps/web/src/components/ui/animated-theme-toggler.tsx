...
export function AnimatedThemeToggler({
  ...
  return (
    <button
      ...
      aria-pressed={isDark}
      className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded-full text-app-ink-muted transition-[background-color,color,transform] duration-200 hover:bg-app-surface-soft hover:text-app-ink active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      onClick={toggleTheme}
      type="button"
    >
      <HugeiconsIcon
